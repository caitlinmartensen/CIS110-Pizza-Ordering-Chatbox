...
if userName.lower()== "caty martensen":
    print(f"\nMy creator, {userName}. Pleasure to sever you!")
else:
...
while keepGoing.lower() == "y":
    ...
    while not quantity.isdigit():
        quantity = input("\nValue not recognized. Please enter a numberic value:  ")
    ...
    print("Order has been recieved. ETA is 3 minutes!")
